                                ...
                                if(count($itens)>0):
                                    ...
                                    foreach ($itens as $row): ?>
                                        <tr>
                                            ...
                                            ?></td>
                                            <td><?= $row->sala_id ?></td>
                                             <td> <a class="btn btn-xs btn-info btn btn-info" href="<?php echo site_url(); ?>/admin/agendamento/ver_minha_agenda_geral_reposicao_revisao/<?php echo $row->curso_id ?>/<?php echo $row->turma ?>/<?php echo $row->modulos_id ?>" title="Visulizar este registro"  class="btn btn-mini btn-primary"><i class="fa fa-eye"></i>Ver Participacao</a></td>
                                        </tr>
                                    <?php endforeach;?>
                                    <?php endif;?>
                            </tbody>
