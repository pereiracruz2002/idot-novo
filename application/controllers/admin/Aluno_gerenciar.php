...
class Aluno_Gerenciar extends BaseCrud {


    var $modelname = 'agendamento';
    var $base_url = 'admin/aluno_gerenciar';
    var $actions = 'R';
    var $titulo = 'Alunos';
    ...
    var $acoes_controller = array(array('url'=>'admin/alunos/novo','title'=>'Novo','class'=>'btn btn-primary'));
    var $turmas_id;
    var $mesa;
    var $minha_mesa;
    var $sala;
